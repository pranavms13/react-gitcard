...
class GitUserCard extends React.Component {
  constructor(props) {
    ...
    if (this.props.variant === 'dark') this.varient = true
    else this.varient = false
    ...
    return (
      <div
        style={{
          ...
          background: this.varient ? '#2e2e2e' : '#FFFFFF',
          color: this.varient ? '#ffffff' : '#000000'
        }}
      >
            ...
            <td>
              <span>
                <svg width='30px' height='30px' viewBox='0 0 496 512'>
                  <path
                    fill={this.varient ? '#FFFFFF' : '#000000'}
